        ...
        <div className='overflow-scroll resume max-w-[1440px] mx-auto'>
            <div className='resume-head border-b border-[#334155] '>
                <div className='py-6 resume-content'>
                    <div className='py-6'>
                        <h2 className='text-[40px] leading-[32px] font-bold'>Mickey Uryvalkin</h2>
                    ...
                    <div className='md:flex justify-center'>
                        ...
                        <div className='flex items-center'>
                            ...
                            <span className='text-[14px]'>mickey.ur@gmail.com</span>
                        </div>
                        {/* <div className='flex items-center'>
                    ...
                    <div className='flex justify-center my-4'>
                        <a href="https://www.linkedin.com/in/jeffery-s-6445271b9" target='_blank' className='flex items-center bg-[#F6F3FF] text-[#000000] px-4 py-px rounded-full mx-2 text-[12px]'><img src={linkedin} alt="" /> <span className='mx-2'>MickeyUr</span> </a>
                        ...
                        <a href="https://github.com/jefferystewart" target='_blank' className='flex items-center bg-[#F6F3FF] text-[#000000] px-4 py-px rounded-full mx-2 text-[12px]'><img src={github} alt="" /> <span className='mx-2'>MickeyUr</span> </a>
                    </div>
                </div>
            </div>
