    ...
    <div className="border-t border-b border-border-bg ">
      <div className=" flex  items-center">
        ...
        <ul className="flex md:w-10/12">
          ...
          {/* <li className='footer-links border-x'><a href='https://www.facebook.com/mickey.ur/' target='_blank'><img src={facebook} alt="" /></a></li>
                    <li className='footer-links border-x'><a href='https://stackoverflow.com/users/16854390/mickey.ur' target='_blank'><img src={stackOverflow} alt="" /></a></li> */}
